Processing contract: /home/jiaming/slither_fp_files/out2550.sol:DPInsuranceFund
  Attempt to decompile the contract with methods...
  Failed to decompile methods. Attempt to decompile the contract without identifying methods...
  Propagating constants...
  Verifying patterns...
Processing contract: /home/jiaming/slither_fp_files/out2550.sol:DoubleProfit
  Attempt to decompile the contract with methods...
  Failed to decompile methods. Attempt to decompile the contract without identifying methods...
  Propagating constants...
  Verifying patterns...
Processing contract: /home/jiaming/slither_fp_files/out2550.sol:SafeMath
  Attempt to decompile the contract with methods...
  Failed to decompile methods. Attempt to decompile the contract without identifying methods...
  Propagating constants...
  Verifying patterns...
[33mWarning[0m for DAOConstantGas in contract 'DPInsuranceFund':
  ...
  > |            msg.sender.transfer(payAmount);
    ...
    |        }
  at /home/jiaming/slither_fp_files/out2550.sol(405)
...
[33mWarning[0m for LockedEther in contract 'DPInsuranceFund':
  ...
  > |contract DPInsuranceFund {
    ...
    |
  at /home/jiaming/slither_fp_files/out2550.sol(263)
...
[33mWarning[0m for TODAmount in contract 'DPInsuranceFund':
  ...
  > |                    msg.sender.transfer(msg.value - deposit.div(10));
    |                }
    |                countOfInvestors++;
  at /home/jiaming/slither_fp_files/out2550.sol(394)
...
[33mWarning[0m for UnhandledException in contract 'DPInsuranceFund':
  ...
  > |                require(countOfInvestors.add(1) <= DPContract.countOfInvestors().mul(32).div(100));
    |                uint256 deposit;
    |                uint256 withdrawals;
  at /home/jiaming/slither_fp_files/out2550.sol(388)
...
[33mWarning[0m for UnhandledException in contract 'DPInsuranceFund':
  ...
  > |                (deposit, withdrawals, investor.insured) = DPContract.setInsured(msg.sender);
    |                require(msg.value >= deposit.div(10) && deposit > 0);
    |                if (msg.value > deposit.div(10)) {
  at /home/jiaming/slither_fp_files/out2550.sol(391)
...
[31mViolation[0m for UnrestrictedWrite in contract 'DPInsuranceFund':
  ...
  > |        DPAddress = _DPAddress;
    ...
    |    }
  at /home/jiaming/slither_fp_files/out2550.sol(305)
...
[31mViolation[0m for UnrestrictedWrite in contract 'DPInsuranceFund':
  ...
  > |        DPContract = DoubleProfit(DPAddress);
    |    }
    |
  at /home/jiaming/slither_fp_files/out2550.sol(306)
...
[31mViolation[0m for UnrestrictedWrite in contract 'DPInsuranceFund':
  ...
  > |        startOfPayments = true;
    ...
    |    }
  at /home/jiaming/slither_fp_files/out2550.sol(376)
...
[31mViolation[0m for UnrestrictedWrite in contract 'DPInsuranceFund':
  ...
  > |        totalSupply = address(this).balance;
    |    }
    |
  at /home/jiaming/slither_fp_files/out2550.sol(377)
...
[33mWarning[0m for UnrestrictedWrite in contract 'DPInsuranceFund':
  ...
  > |                totalNotReceived = totalNotReceived.add(deposit.sub(investor.deposit));
    ...
    |            }
  at /home/jiaming/slither_fp_files/out2550.sol(321)
...
[33mWarning[0m for UnrestrictedWrite in contract 'DPInsuranceFund':
  ...
  > |                investor.deposit = deposit;
    |            }
    |
  at /home/jiaming/slither_fp_files/out2550.sol(322)
...
[33mWarning[0m for UnrestrictedWrite in contract 'DPInsuranceFund':
  ...
  > |                        totalNotReceived = totalNotReceived.sub(different);
    |                    else
    |                        totalNotReceived = 0;
  at /home/jiaming/slither_fp_files/out2550.sol(331)
...
[33mWarning[0m for UnrestrictedWrite in contract 'DPInsuranceFund':
  ...
  > |                        totalNotReceived = 0;
    ...
    |                } else {
  at /home/jiaming/slither_fp_files/out2550.sol(333)
...
[33mWarning[0m for UnrestrictedWrite in contract 'DPInsuranceFund':
  ...
  > |                        totalNotReceived = totalNotReceived.sub(different);
    |                    else
    |                        totalNotReceived = 0;
  at /home/jiaming/slither_fp_files/out2550.sol(338)
...
[33mWarning[0m for UnrestrictedWrite in contract 'DPInsuranceFund':
  ...
  > |                        totalNotReceived = 0;
    |
    |                }
  at /home/jiaming/slither_fp_files/out2550.sol(340)
...
[33mWarning[0m for UnrestrictedWrite in contract 'DPInsuranceFund':
  ...
  > |            investor.withdrawals = withdrawals;
    ...
    |        }
  at /home/jiaming/slither_fp_files/out2550.sol(344)
...
[33mWarning[0m for UnrestrictedWrite in contract 'DPInsuranceFund':
  ...
  > |                countOfInvestors++;
    ...
    |            }
  at /home/jiaming/slither_fp_files/out2550.sol(396)
...
[33mWarning[0m for UnrestrictedWrite in contract 'DPInsuranceFund':
  ...
  > |            investor.insured = false;
    |            msg.sender.transfer(payAmount);
    |            emit Paid(msg.sender, payAmount, notReceived, partOfNotReceived);
  at /home/jiaming/slither_fp_files/out2550.sol(404)
...
[33mWarning[0m for UnrestrictedWrite in contract 'DPInsuranceFund':
  ...
  > |        investor.deposit = 0;
    ...
    |        investor.insured = false;
  at /home/jiaming/slither_fp_files/out2550.sol(365)
...
[33mWarning[0m for UnrestrictedWrite in contract 'DPInsuranceFund':
  ...
  > |        investor.withdrawals = 0;
    |        investor.insured = false;
    |        countOfInvestors--;
  at /home/jiaming/slither_fp_files/out2550.sol(366)
...
[33mWarning[0m for UnrestrictedWrite in contract 'DPInsuranceFund':
  ...
  > |        investor.insured = false;
    |        countOfInvestors--;
    |    }
  at /home/jiaming/slither_fp_files/out2550.sol(367)
...
[33mWarning[0m for UnrestrictedWrite in contract 'DPInsuranceFund':
  ...
  > |        countOfInvestors--;
    |    }
    |
  at /home/jiaming/slither_fp_files/out2550.sol(368)
...
[33mWarning[0m for LockedEther in contract 'SafeMath':
  ...
  at /home/jiaming/slither_fp_files/out2550.sol(210)
