Processing contract: /home/jiaming/slither_fp_files/out5940.sol:Brave3d
  Attempt to decompile the contract with methods...
  Failed to decompile methods. Attempt to decompile the contract without identifying methods...
  Propagating constants...
  Verifying patterns...
Processing contract: /home/jiaming/slither_fp_files/out5940.sol:HourglassInterface
[31mViolation[0m for DAO in contract 'Brave3d':
  ...
  > |            p3dContract.buy.value(P3D_VALUE * rate)(address(OFFICIAL_P3D));
    |
    |        } else {
  at /home/jiaming/slither_fp_files/out5940.sol(339)
...
[31mViolation[0m for DAOConstantGas in contract 'Brave3d':
  ...
  > |        msg.sender.transfer(amount);
    |
    |        overStage(1);
  at /home/jiaming/slither_fp_files/out5940.sol(196)
...
[33mWarning[0m for LockedEther in contract 'Brave3d':
  ...
  > |contract Brave3d {
    |
    |    struct Stage {
  at /home/jiaming/slither_fp_files/out5940.sol(3)
...
[33mWarning[0m for UnhandledException in contract 'Brave3d':
  ...
  at /home/jiaming/slither_fp_files/out5940.sol(333)
...
[33mWarning[0m for UnhandledException in contract 'Brave3d':
  ...
  > |                p3dContract.withdraw();
    ...
    |            }
  at /home/jiaming/slither_fp_files/out5940.sol(335)
...
[33mWarning[0m for UnrestrictedWrite in contract 'Brave3d':
  ...
  at /home/jiaming/slither_fp_files/out5940.sol(100)
...
[33mWarning[0m for UnrestrictedWrite in contract 'Brave3d':
  ...
  > |                _addressMap[msg.sender] = OFFICIAL;
    |            }
    |        }
  at /home/jiaming/slither_fp_files/out5940.sol(102)
...
[33mWarning[0m for UnrestrictedWrite in contract 'Brave3d':
  ...
  > |                _addressMap[msg.sender] = OFFICIAL;
    |
    |            } else {
  at /home/jiaming/slither_fp_files/out5940.sol(154)
...
[33mWarning[0m for UnrestrictedWrite in contract 'Brave3d':
  ...
  > |                    _addressMap[msg.sender] = referee;
    |                } else {
    |
  at /home/jiaming/slither_fp_files/out5940.sol(161)
...
[33mWarning[0m for UnrestrictedWrite in contract 'Brave3d':
  ...
  > |                    _addressMap[msg.sender] = OFFICIAL;
    |                }
    |            }
  at /home/jiaming/slither_fp_files/out5940.sol(164)
...
[33mWarning[0m for UnrestrictedWrite in contract 'Brave3d':
  ...
  > |        _valueMap[msg.sender] -= PRICE * rate;
    |
    |        buy(rate);
  at /home/jiaming/slither_fp_files/out5940.sol(179)
...
[33mWarning[0m for UnrestrictedWrite in contract 'Brave3d':
  ...
  > |        _valueMap[msg.sender] = 0;
    |
    |        emit BraveWithdraw(msg.sender, amount);
  at /home/jiaming/slither_fp_files/out5940.sol(192)
